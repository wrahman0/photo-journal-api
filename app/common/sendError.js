...
module.exports = function sendError(httpError, next) {
    return function (err) {
        ...
        errorInstance.body.detail = errorInstance.body.message;
        errorInstance.body.type = err.errorCode;
        delete errorInstance.body.message;
        delete errorInstance.body.code;
